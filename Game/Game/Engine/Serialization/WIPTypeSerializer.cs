...
{
    class WIPTypeSerializer<BaseType> : LinkedSerializer<BaseType>
    {
        private TypeFactory<BaseType> factory;

        public WIPTypeSerializer(TypeFactory<BaseType> factory, Serializer<BaseType> nestedSerializer, Deserializer<BaseType> nestedDeserializer) : base(nestedSerializer, nestedDeserializer)
        {
